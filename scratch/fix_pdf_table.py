...
def main():
    with open('scratch/new_potensi_function.dart', 'r', encoding='utf-8') as f:
        content = f.read()
    
    start_str = 'List<pw.Widget> dataRows = [];'
    end_str = 'return dataRows;'
    ...
    new_logic = """List<pw.TableRow> tableRows = [];
          ...
          return [
            pw.Table(
              ...
              columnWidths: {
                for (int j = 0; j < 30; j++)
                  j: const pw.FlexColumnWidth(1),
              },
              children: tableRows,
            )
          ];"""
          
    new_logic = new_logic.replace("const pw.FlexColumnWidth(1)", "j == 1 ? const pw.FlexColumnWidth(4) : const pw.FlexColumnWidth(1)")
    
    with open('scratch/new_potensi_function.dart', 'w', encoding='utf-8') as f:
